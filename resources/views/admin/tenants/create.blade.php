...
@section('header_title', 'Nueva Agencia (Tenant)')

@section('content')
<div class="max-w-3xl mx-auto">
    <div class="mb-6 flex items-center justify-between">
        <h3 class="text-2xl font-bold text-gray-800 border-b-2 border-indigo-500 pb-2 inline-block">Registrar Agencia
        </h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <input type="text" name="nombre_empresa" id="nombre_empresa"
                        ...
                        value="{{ old('nombre_empresa') }}" required placeholder="Ej: Agencia Aduanal Nexa">
                ...
                <div>
                    ...
                    <div class="flex rounded-md shadow-sm">
                        <input type="text" name="slug" id="slug"
                            ...
                            value="{{ old('slug') }}" required placeholder="agencia-nexa">
                        <span
                ...
                <div>
                    ...
                    <input type="email" name="correo_admin" id="correo_admin"
                        ...
                        value="{{ old('correo_admin') }}" required placeholder="admin@agencia.com">
                    @error('correo_admin')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="rfc" id="rfc"
                        ...
                        value="{{ old('rfc') }}" placeholder="RFC Empresa">
                </div>
                ...
                <div>
                    ...
                    <select name="plan" id="plan"
                        ...
                        <option value="profesional" {{ old('plan')=='profesional' ? 'selected' : '' }}>Profesional</option>
