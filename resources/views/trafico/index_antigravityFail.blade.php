...
@section('content')
                        ...
                        <tbody>
                            ...
                            @foreach($activas as $grupoKey => $registros)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge-status bg-{{ $color }}" data-bs-toggle="modal"
                                            data-bs-target="#modalModulacion{{ $modalId }}">
                                            <span class="pulse"></span> {{ $estadoMostrar }}
                                        </span>
                                    </td>
                                    <td>
                                        <button class="btn-ack" data-bs-toggle="modal"
                                            data-bs-target="#detalleThermoModal{{ $modalId }}">
                                            <i class="fas fa-eye me-1"></i> Ver Detalles
                                        </button>
                                        <button class="btn-ack ms-1" data-bs-toggle="modal"
                                            data-bs-target="#updateStatusModal{{ $modalId }}">
    ...
    <script>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="${badgeClass}" 
                                                                      onclick="loadModulacionModal('${truck.thermo}', '${truck.alpha}')"
                                                                      style="cursor: pointer;">
                                                                    ${!isHistory ? '<span class="pulse"></span>' : ''} ${truck.estado}
                                                                </span>
                                                            </td>
                                                            <td>
                                                                <button class="btn-ack" onclick="loadDetalleModal('${truck.thermo}', '${truck.alpha}')">
                                                                    <i class="fas fa-eye me-1"></i> Ver Detalles
                                                                </button>
                                                                ${!isHistory ? `
                                                                    <button class="btn-ack ms-1" onclick="loadUbicacionModal('${truck.thermo}', '${truck.alpha}')">
                                                                        <i class="fas fa-map-marker-alt"></i> Ubicación
                                                                    </button>
                                                                    ${isCompleted ? `
                                                                        <button class="btn-acknowledge ms-1" 
        ...
        function loadDetalleModal(thermo, alpha) {
        ...
        function loadUbicacionModal(thermo, alpha) {
        ...
        function loadModulacionModal(thermo, alpha) {
        ...
        function loadConceptosModal(thermo, alpha) {
