...
<head>
    ...
    <title>Ficha Técnica – {{ $first->num_thermo }}</title>
    <style>
...
<div class="header">
    ...
    <div class="header-info">
        <strong>Ficha Técnica de Modulación</strong>
        Modulación: {{ $first->fecha_modulacion }}
    </div>
</div>
...
<div class="status-banner {{ $color }}">
    ...
    <div class="status-text">
        <h2>{{ $estado }}</h2>
        <p>
            @if($color == 'green')   Desaduanamiento Libre.
            @elseif($color == 'red') Reconocimiento Aduanero.
            @else                    La operación sigue en proceso.
            @endif
        </p>
    </div>
</div>
...
<div class="content">
    ...
    <div class="card card-gray">
        <h2>📋 Detalles del Económico</h2>
        <div class="row-item">
            <span class="label">Económico:</span>
    ...
    <div class="card card-blue">
        ...
        <div class="row-item">
            ...
            <span class="value">{{ $r->num_factura ?? 'N/A' }}</span>
        </div>
        @endforeach
    </div>
...
{{-- Footer --}}
<div class="footer">
    <span>Plataforma – Crosspoint</span>
    <span>{{ $first->num_thermo }} | {{ $first->codigo_alpha }}</span>
</div>


<script>
    // Auto-trigger el diálogo de impresión al cargar, después de un pequeño delay
    // para que los estilos terminen de cargar
