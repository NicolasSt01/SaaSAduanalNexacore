    ...
    <div class="container-fluid px-4">
        ...
        <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
            ...
            <div class="btn-group">
                ...
                <a href="{{ route('expedientes.edit', $expediente) }}" class="btn btn-warning">
                    <i class="fas fa-edit me-1"></i> Editar
                </a>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#cerrarFirmaModal">
                    <i class="fas fa-pen me-1"></i> Cerrar Firma
                </button>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label class="form-label text-muted small mb-1">Documentador que Registró</label>
                                    <p class="mb-0 fs-6">{{ $expediente->documentador->name }}</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="pdf-container" class="d-none">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <div>
                                <span class="text-muted">Página <span id="page-num">1</span> de <span
                        ...
                        <div class="pdf-viewer-container"
                            style="overflow: auto; max-height: 70vh; border: 1px solid #dee2e6;">
