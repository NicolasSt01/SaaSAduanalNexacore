            ...
            <td align="center">
                ...
                <table width="650" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; max-width: 650px;">
                    ...
                    @php
                        ...
                        } elseif (in_array($estatusUpper, ['RECONOCIMIENTO ADUANERO', 'RECONOCIMIENTO ADUANERO CONCLUIDO','TRAMITE EN PROCESO DE REVISION'])) {
                            $bgColor = '#DC143C'; // Rojo
                            $statusIcon = '🔍';
                            $statusSubtitle = 'Su trámite está en proceso de inspección';
                        } else {
                            //$bgColor = '#3b82f6'; // Azul por defecto
                            $bgColor = '#DC143C'; // Rojo por defecto
                            $statusIcon = 'ℹ️';
                                ...
                                <tr>
                                    <td>
                                        {{--<p style="margin: 0 0 25px 0; font-size: 20px; color: #1a202c; font-weight: 600;">
                                            Estimado {{ $cliente->persona_contacto }},
                                        </p>--}}
                                        <p style="margin: 0 0 25px 0; font-size: 20px; color: #1a202c; font-weight: 600;">
                                            Estimado Cliente {{ $cliente->persona_contacto }},
                                        </p>
